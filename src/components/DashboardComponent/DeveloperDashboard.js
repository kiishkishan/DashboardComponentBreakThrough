...
import DeveloperMultiAxisDataSevAndPrioChart from './Elements/DeveloperMultiAxisDataSevAndPrioChart';
...
class DevDashboard extends Component {
  ...
  render() {
    // const data = {
    //   labels: ['New', 'Open', 'Reject', 'Closed'],L
    //   datasets: [
    //     {
    //       data: [55, 5, 10, 30],
    //       backgroundColor: [
    ...
    return (
      <React.Fragment>
        ...
        <br />
        <Col span={24}>
          <DeveloperMultiAxisDataSevAndPrioChart />
