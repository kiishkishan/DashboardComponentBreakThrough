...
import './index.css';
import SeverityMeter from './Elements/SeverityMeter';
import DefectPriorityAndSeverityChart from './Elements/DefectPriorityAndSeverityChart';
                ...
                <Row gutter={10} style={{ textAlign: "center" }}>
                    ...
                    <Col className="gutter-row" span={12}>
                        <div className="gutter-box" >
                            ...
                            <DefectPriorityAndSeverityChart />
                            {/* <Row>
                                <div
                                    style={{
                                        padding: 24,
